...
- **Motivation and Framing:**
  Uploading some notebook samples to GitHub repositories sounds simple, but creating and persisting a long-term modeling asset for IDM is a challenge that calls on skills from across the whole of IDM.

- **Example:**
  DHS survey data is used across IDM but it can be challenging due to its complex structure and different recode scheme. How do we maintain a reusable code base to ease the handling of DHS data?
